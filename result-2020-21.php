...
<html lang="en">
  ...
  <head>
    ...
    <title>Shah Satnam ji Girls School Sirsa | Results  </title>
          ...
          <div class="col-lg-12">
            <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
              <div class="section-heading">
                <h2 class="section__title text-white">Results 2020-2021</h2>
              </div>
...
<!-- ================================
         END INFO BOX AREA
================================= -->
<section class="info-box-area pb-90px">
<div class="section-heading text-center">
            <h2 class="section__title">
            Results 2020-2021</h2>
            <span class="section-divider"></span>
          </div> 
    <div class="container">
       
        <div class="row pt-50px justify-content-center">
            <div class="col-lg-3 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        <svg class="svg-icon-color-4" width="60" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                        ...
                        <h5 class="card-title pt-4 pb-2 fs-18">Class X</h5>
                        <Check class="card-text"><a href="class-10-2020-21.php">Check Results</a></p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2 fs-18">Class XII</h5>
                        <p class="card-text"><a href="class-12-2020-21.php">Check Results</a></p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-3 -->
