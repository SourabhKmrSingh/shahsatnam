...
function fetch_category()
{
	$.ajax({
		...
		{
			brandid: $("#brandid").val(),
			categoryid: "<?php echo $productRow['categoryid']; ?>",
			mode: "<?php echo $mode; ?>"
		},
		success: function(result)
		{
			$("#category_area").html(result);
		}
	});
}
...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header"><?php if($mode == "insert") echo "Add New"; else echo "Update"; ?> Course</h1>
	</div>
</div>
...
<div class="form-rows-custom mt-3">
	...
	<!-- <div class="row mb-3">
		...
		<div class="col-sm-9">
			<select NAME="brandid" CLASS="form-control" ID="brandid" onChange="fetch_category();" >
				<option VALUE="">--select--</option>
				<?php
				$brandQueryResult = $db->view('brandid,title', 'rb_brand_solution', 'brandid', "and status='active'", 'title asc');
				foreach($brandQueryResult['result'] as $brandRow)
				{
				?>
					<option VALUE="<?php echo $validation->db_field_validate($brandRow['brandid']); ?>" <?php if($mode == 'edit') { if($brandRow['brandid'] == $productRow['brandid']) echo "selected"; } ?>><?php echo $validation->db_field_validate($brandRow['title']); ?></option>
				<?php
				}
				?>
			</select>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9" id="category_area">
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="text" name="age" id="age" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($productRow['age']); ?>" />
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="text" name="class" id="class" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($productRow['class']); ?>" />
		</div>
	</div>
	...
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="product_code">Course Code</label>
		</div>
		<div class="col-sm-9">
	...
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="mrp">Course MRP *</label>
		</div>
		<div class="col-sm-9">
			<input type="text" name="mrp" id="mrp" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($productRow['mrp']); ?>" required />
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="text" name="price" id="price" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($productRow['price']); ?>" required />
		</div>
	</div>
			...
			<tbody>
				<?php if($mode == 'edit') { ?>
					...
					?>
						...
						<tr>
							<td><input type="text" name="title[]" id="title" class="form-control" value="<?php echo $validation->db_field_validate($variantRow['title']); ?>" /></td>
							<td><input type="text" name="point[]" id="point" class="form-control" value="<?php echo $validation->db_field_validate($variantRow['point']); ?>" /></td>
	...
	<!-- <div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="checkbox" name="trending" id="trending" <?php if($mode == 'edit') { if($productRow['trending'] == "1") echo "checked"; } ?> />
		</div>
	</div> -->
		...
		<div class="col-sm-12">
			...
			?>
				...
				<?php if($_SESSION['per_delete'] == "1") { ?>
					<a HREF="product_actions.php?q=del&productid=<?php echo $productRow['productid']; ?>" class="btn  btn-sm btn_delete" onClick="return del();"><i class="fas fa-trash"></i>&nbsp;&nbsp;Delete</a>
				<?php } ?>
			<?php
			}
			?>
