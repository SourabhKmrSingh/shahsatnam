...
@$name_id = strtolower($validation->input_validate($_GET['name_id']));
...
if($name_id != "")
{
	$where_query .= " and name_id = '$name_id'";
}
if($status != "")
{
...
$table = "rb_testimonial";
$id = "testimonialid";
$url_parameters = "&userid=$userid&name=$name&name_id=$name_id&status=$status&datefrom=$datefrom&dateto=$dateto";
...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Testimonials <?php if($_SESSION['per_write'] == "1") { ?><a href="testimonial_form.php?mode=insert"  class="btn mb_inline btn-sm btn_submit ml-3 mt-1">Add New</a><?php } ?></h1>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12 mb-0">
		<div class="form-inline">
			...
			<a href="testimonial_view.php" class="btn  mb_inline btn-sm btn_delete ml-sm-2 ml-md-0 mb-2">Clear</a>
		</div>
	</div>
</div>
