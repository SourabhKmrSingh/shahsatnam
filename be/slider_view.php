...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Sliders <?php if($_SESSION['per_write'] == "1") { ?><a href="slider_form.php?mode=insert"  class="btn mb_inline btn-sm btn_submit ml-3 mt-1">Add New</a><?php } ?></h1>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12 mb-0">
		<div class="form-inline">
			...
			<a href="slider_view.php" class="btn  mb_inline btn-sm btn_delete ml-sm-2 ml-md-0 mb-2">Clear</a>
		</div>
	</div>
</div>
