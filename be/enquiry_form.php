...
if($mode == "edit")
{
	...
	$enquiryQueryResult = $db->view('*', 'rb_enquiries', 'enquiryid', "and enquiryid = '$enquiryid'");
...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header"><?php if($mode == "insert") echo "Add New"; else echo "Update"; ?> Enquiry</h1>
	</div>
</div>
...
<div class="form-rows-custom mt-3">
	<input type="hidden" name='enquiry_type' value='<?php echo $enquiryRow['enquiry_type'];?>'>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<select name='courseid' class='form-control'>
				<option value="" selescted="">Select Course.</option>
				<?php foreach($courseResult['result'] as $courseRow){?>
					<option value="<?php echo $courseRow['productid'];?>" <?php if($mode == "edit"){ if($enquiryRow['courseid'] == $courseRow['productid']){ echo "selected"; } }?>><?php echo $courseRow['title'];?></option>
				<?php }?>
			</select>
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="date" name="registration_date" id="registration_date" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($enquiryRow['registration_date']); ?>" />
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<select name="status" id="status" class="form-control" required >
				<option value="active" <?php if($mode == 'edit') { if($validation->db_field_validate($enquiryRow['status']) == "active") echo "selected"; } ?>>Active</option>
				<option value="inactive" <?php if($mode == 'edit') { if($validation->db_field_validate($enquiryRow['status']) == "inactive") echo "selected"; } ?>>Inactive</option>
			</select>
		</div>
	</div>
		...
		<div class="col-sm-12">
			...
			?>
				...
				<?php if($_SESSION['per_delete'] == "1") { ?>
					<a HREF="enquiry_actions.php?q=del&enquiryid=<?php echo $enquiryRow['enquiryid']; ?>" class="btn  btn-sm btn_delete" onClick="return del();"><i class="fas fa-trash"></i>&nbsp;&nbsp;Delete</a>
				<?php } ?>
			<?php
			}
			?>
