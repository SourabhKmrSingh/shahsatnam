...
<div class="form-rows-custom mt-3">
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="text" name="btnTitle" id="btnTitle" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($sliderRow['btnTitle']); ?>" /> 
		</div>
	</div>
		...
		<div class="col-sm-12">
			...
			?>
				...
				<?php if($_SESSION['per_delete'] == "1") { ?>
					<a HREF="slider_actions.php?q=del&sliderid=<?php echo $sliderRow['sliderid']; ?>" class="btn  btn-sm btn_delete" onClick="return del();"><i class="fas fa-trash"></i>&nbsp;&nbsp;Delete</a>
				<?php } ?>
			<?php
			}
			?>
