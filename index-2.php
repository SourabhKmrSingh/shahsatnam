              ...
              <div class="course-carousel owl-action-styled owl--action-styled">
                <div class="card card-item">
                  <div class="card-image">
                    <a href="#" class="d-block">
                      <img class="card-img-top" src="images/gallery/9.jpg" alt="Card image cap">
                    </a>
                    <div class="course-badge-labels">
                      <div class="course-badge">Awards</div>
                    </div>
                  </div>
                  <!-- end card-image -->
                  <div class="card-body">
                    <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">Awards</h6>
                    <h5 class="card-title">
                      <a href="#">Shining star of Asia Awards</a>
                    </h5>
                    <p class="card-text">With the blessings of Saint Dr. MSG, Dr. Sheela Puniya, Principal, of the school was awarded with the Shining Star of Asia Award by The International American Council for Research and Development in association with International Business Council and International Institute of Education and Management </p>
                    <!-- end rating-wrap -->
                  </div>
                  <!-- end card-body -->
                </div>
                ...
                <div class="card card-item">
                  ...
                  <div class="card-body">
                    ...
                    <h5 class="card-title">Shining star of Asia Awards</h5>
                    <p class="card-text">With the blessings of Saint Dr. MSG, Dr. Sheela Puniya, Principal, of the school was awarded with the Shining Star of Asia Award by The International American Council for Research and Development in association with International Business Council and International Institute of Education and Management </p>
                    <!-- end rating-wrap -->
                  </div>
                  <!-- end card-body -->
            ...
            <div class="col-lg-5 ml-auto">
              <form method="post" class="subscriber-form">
                <div class="input-group d-flex">
                  <input type="email" name="email" style='width: 70%;' class="form-control form--control pl-3" placeholder="Enter email address">
                  <div class="input-group-append">
                    <button class="btn theme-btn" type="button">Subscribe <i class="la la-arrow-right icon ml-1"></i>
                    </button>
                  </div>
                </div>
                <p class="fs-14 mt-1">
