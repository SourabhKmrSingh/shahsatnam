          ...
          <div class="col-lg-12">
            <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
              <div class="section-heading">
                <h2 class="section__title text-white">Results 2019-2020</h2>
              </div>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text"><a href="class-10-2019-20.php">Check Results</a></p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text"><a href="class-12-2019-20.php">check Results</a></p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-3 -->
